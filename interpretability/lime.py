...
class LIME:
    ...
    def fit_local_surrogate_model(self, perturbations, predictions, top_class_index):
        """
        Fits a Ridge regression model to get the local surrogate model weights.
    ...
    def visualize_local_surrogate_model(self, image, segments, weights, i=0):
        ...
        top_segments = np.argsort(weights)[-15:]
    ...
    def fit(self, top_n=2):
        """
        Fits the local_surrogate model for the top N predictions and visualizes the results.
