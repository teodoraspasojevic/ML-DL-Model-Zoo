...
class GAN:
    def __init__(self, latent_dim):
        ...
        self.generator = Generator1x28x28(latent_dim=latent_dim).to(device)
        self.discriminator = Discriminator1x28x28().to(device)
...
if __name__ == '__main__':
    ...
    history = gan.train(dataloader=mnist_dl, num_epochs=300, lr=0.0002)
